...
```{r}
rbf_variables = read.table("/Users/akaike/Documents/fall22/STAT615/final pj/rbf_variable_250.txt",header = FALSE)
length(rbf_variables$V1)
model_rbf = lm(Value ~. , data = data_normalized[587:8352,c("Value",rbf_variables$V1)])
```
  
```{r}
summary(model_rbf)
library("car")
qqPlot(resid(model_rbf))
rbf_RMSE = sqrt(sum(resid(model_rbf)^2)/length(resid(model_rbf)))
rbf_RRMSE = rbf_RMSE/mean(Y_train)
```

\section{2017 prediction 250 variables}
```{r}
data_normalized2 = cbind(data_origin[,c(1:8)],data_normalized)
data_2017 = data_normalized2[data_normalized2$Year==2017,]
```
\subsection{2017 Illinois 250 variables}
```{r warning=FALSE}
#2017_predictions_Illinois_250 variables
...
#        data_county[c, c((258+(week+1)*11):697)] = temp_data[Illinois_2017$County == county,c((258+(week+1)*11):697)]
    ...
    yhat0 <- predict(model_rbf, newdata=  data_county[,c(rbf_variables$V1)])
...
```{r warning=FALSE}
yhat_Illinois_2017_RFE250 = predict(model_rbf, newdata = Illinois_2017[,c(rbf_variables$V1)])
res = Illinois_2017$Value - yhat_Illinois_2017_RFE250

Illinois_2017_RFE250_RMSE = sqrt(sum(res^2)/length(res))
Illinois_2017_RFE250_RRMSE = Illinois_2017_RFE250_RMSE/mean(Illinois_2017$Value)
print(c(Illinois_2017_RFE250_RMSE,Illinois_2017_RFE250_RRMSE))

RRMSE_for_county_Illinois_2017_RFE250 = sqrt(res^2)/Illinois_2017$Value
write.table(RRMSE_for_county_Illinois_2017_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_RBF250_ALLDATA/RRMSE_for_county_Illinois_2017_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```

\subsection{2017 IOWA 250 variables}
```{r warning=FALSE}
#2017_predictions_IOWA_250 variables
...
```{r warning=FALSE}
yhat_IOWA_2017_RFE250 = predict(model_rbf, newdata=  IOWA_2017[,c(rbf_variables$V1)])
res = IOWA_2017$Value - yhat_IOWA_2017_RFE250

IOWA_2017_RFE250_RMSE = sqrt(sum(res^2)/length(res))
IOWA_2017_RFE250_RRMSE = IOWA_2017_RFE250_RMSE/mean(IOWA_2017$Value)
print(c(IOWA_2017_RFE250_RMSE,IOWA_2017_RFE250_RRMSE))

RRMSE_for_county_IOWA_2017_RFE250 = sqrt(res^2)/IOWA_2017$Value

write.table(RRMSE_for_county_IOWA_2017_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_RBF250_ALLDATA/RRMSE_for_county_IOWA_2017_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```


\subsection{2017 INDIANA 250 variables}
```{r warning=FALSE}
#2017_predictions_INDIANA_250 variables
...
```{r warning=FALSE}
yhat_INDIANA_2017_RFE250 = predict(model_rbf, newdata=  INDIANA_2017[,c(rbf_variables$V1)])
res = INDIANA_2017$Value - yhat_INDIANA_2017_RFE250

INDIANA_2017_RFE250_RMSE = sqrt(sum(res^2)/length(res))
INDIANA_2017_RFE250_RRMSE = INDIANA_2017_RFE250_RMSE/mean(INDIANA_2017$Value)
print(c(INDIANA_2017_RFE250_RMSE,INDIANA_2017_RFE250_RRMSE))

RRMSE_for_county_INDIANA_2017_RFE250 = sqrt(res^2)/INDIANA_2017$Value
write.table(RRMSE_for_county_INDIANA_2017_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_RBF250_ALLDATA/RRMSE_for_county_INDIANA_2017_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```
...
```{r}
model_rbf = lm(Value ~. , data = data_normalized[294:8352,c("Value",rbf_variables$V1)])
```
...
\subsection{2018 Illinois RFE 250 variables}
```{r warning=FALSE}
#2018_predictions_Illinois_RFE 250 variables
...
```{r warning=FALSE}
yhat_Illinois_2018_RFE250 = predict(model_rbf, newdata=  Illinois_2018[,c(rbf_variables$V1)])
res = Illinois_2018$Value - yhat_Illinois_2018_RFE250

Illinois_2018_RFE250_RMSE = sqrt(sum(res^2)/length(res))
Illinois_2018_RFE250_RRMSE = Illinois_2018_RFE250_RMSE/mean(Illinois_2018$Value)
print(c(Illinois_2018_RFE250_RMSE, Illinois_2018_RFE250_RRMSE))

RRMSE_for_county_Illinois_2018_RFE250 = sqrt(res^2)/Illinois_2018$Value
write.table(RRMSE_for_county_Illinois_2018_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_RBF250_ALLDATA/RRMSE_for_county_Illinois_2018_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```

\subsection{2018 IOWA RFE 250 variables}
```{r warning=FALSE}
#2018_predictions_IOWA_RFE 250 variables
...
```{r warning=FALSE}
yhat_IOWA_2018_RFE250 = predict(model_rbf,  newdata=  IOWA_2018[,c(rbf_variables$V1)])
res = IOWA_2018$Value - yhat_IOWA_2018_RFE250

IOWA_2018_RFE250_RMSE = sqrt(sum(res^2)/length(res))
IOWA_2018_RFE250_RRMSE = IOWA_2018_RFE250_RMSE/mean(IOWA_2018$Value)
print(c(IOWA_2018_RFE250_RMSE, IOWA_2018_RFE250_RRMSE))

RRMSE_for_county_IOWA_2018_RFE250 = sqrt(res^2)/IOWA_2018$Value
write.table(RRMSE_for_county_IOWA_2018_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_RBF250_ALLDATA/RRMSE_for_county_IOWA_2018_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```
...
```{r warning=FALSE}
yhat_INDIANA_2018_RFE250 = predict(model_rbf, newdata=  INDIANA_2018[,c(rbf_variables$V1)])
res = INDIANA_2018$Value - yhat_INDIANA_2018_RFE250

INDIANA_2018_RFE250_RMSE = sqrt(sum(res^2)/length(res))
INDIANA_2018_RFE250_RRMSE = INDIANA_2018_RFE250_RMSE/mean(INDIANA_2018$Value)
print(c(INDIANA_2018_RFE250_RMSE, INDIANA_2018_RFE250_RRMSE))

RRMSE_for_county_INDIANA_2018_RFE250 = sqrt(res^2)/INDIANA_2018$Value
write.table(RRMSE_for_county_INDIANA_2018_RFE250, "/Users/akaike/Documents/fall22/STAT615/final pj/RRMSE_for_county_INDIANA_2018_RFE250.txt", append = FALSE, sep = " ", dec = ".",
            row.names = TRUE, col.names = TRUE)
```